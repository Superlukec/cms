...
@Component({
  selector: 'app-shareables',
  templateUrl: './shareables.component.html',
  styleUrls: ['./shareables.component.scss']
})
export class ShareablesComponent implements OnInit, OnDestroy {
